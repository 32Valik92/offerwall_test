   ...
   return (
      <div key={book.id} className="buy-book-item">
         <div className="book">
            ...
            <div className="book-price">${(book.price * count).toFixed(2)}</div>
         </div>

         <div className="trash" onClick={() => dispatch(bookActions.removeBookFromCart(book.id))}><img src="/images/trash.svg" alt="trash"/></div>
      </div>
   );
};
